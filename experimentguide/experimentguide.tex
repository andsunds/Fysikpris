...
\footnotetext{Se bilaga \ref{sec:statistik} för en grundligare
  behandlig av statistik och speciellt normalfördelningen. }
...
man får linjära samband. Detta handlar om att göra ett fiffigt val av
...
\footnotetext{För att inte bli anklagad för plagiat bör här nämnas
  att det här avsnittet är baserat på innehållet i artikeln
  A. Sundström \& T. Adawi, 2016, \textit{Measuring g using a rotating
    liquid mirror: enhancing laboratory learning}, Physics education,
  \textbf{51}. (Det finns en kopia av artikeln här:
  \url{https://github.com/andsunds/Rotating_Bowl} filen heter
  \texttt{Sundstrom-Adawi\_2016.pdf}).
}
